...
namespace DSS
{
    partial class AboutBox1 : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Не удалось перейти по ссылке.");
            }

        }
        private void VisitLink()
        {
            System.Diagnostics.Process.Start("http://dental-ss.at.ua");
        }
        ...
        private void MailTo()
        {
            System.Diagnostics.Process.Start("mailto:doctor.dss@mail.ru");// ("http://dental-ss.at.ua");
        }
